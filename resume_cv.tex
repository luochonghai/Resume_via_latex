...
\name{罗辉翔}{}
\address{复旦大学，张衡路 825号（张江校区），上海， 中国 200120}
\mobile{(+86) 18964623263}

\email{15307130012@fudan.edu.cn}
\github{https://github.com/luochonghai}
% \linkedin{posquit0}
%\skype{skypeid}
...
\makecvfooter{\today}{Huixiang Luo {\enskip\cdotp\enskip} Resume}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
